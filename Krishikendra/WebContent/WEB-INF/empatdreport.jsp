...
<head>
  ...
  <link rel="https://cdn.datatables.net/buttons/1.6.5/css/buttons.dataTables.min.css">
   ...
   <script type="text/javascript">   
        function deleteempatdreport(val)
        {
        	//alert(11);
        	var a=val;
        	//alert(a);
...
<div class="wrapper">
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="empAtdRepInsert">
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="empAtdRepUpdate" method="post">
                 
                 <%
                 try{
                                Connection con1=new connectionClass().getConnection();
                        		Statement stm=con1.createStatement();
                        		String sql="select * from empatdreport_table where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="text" value="<%=id1%>" name="empatdrepID">
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                                   ...
                                   Statement smt=con.createStatement();
                                    	String sql = "select * from empatdreport_table";
								   ...
								   <a href="empatdreport?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteempatdreport(<%=rs.getString("id")%>)"  class="text-white btn btn-success"> Delete</a>
		  ...
		  <div class="modal fade" id="myModalDelete" role="dialog">
		    <div class="modal-dialog">
		     ...
		     <!--      <button type="button" class="close btn btn-success hover" data-dismiss="modal">&times;</button>
		        ...
		        <form action="empAtdRepDelete" method="POST">
		        <div class="modal-body">
		          
		          	<input type="hidden" id="empatdrepID_d" name="empatdrepID">
