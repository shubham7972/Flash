...
<div class="wrapper">
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="empInsert">
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="empUpdate" method="post">
                 
                 <%
                 try{
                                Connection con1=new connectionClass().getConnection();
                        		Statement stm=con1.createStatement();
                        		String sql="select * from emp_table where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="text" value="<%=id1%>" name="empID">
                    </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
								   ...
								   <a href="empdetails?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteEmp(<%=rs.getString("id")%>)"  class="text-white btn btn-success"> Delete</a>
