...
<div class="wrapper">
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="expenseInsert">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>MonthlyExpense</label>
                          <input class="form-control" type="text" name="monthlyExpense">
                      </div>
                    </div>
                     ...
                     <div class="col-sm-4">
                      <div class="form-group">
                        <label>MonthlyRent</label>
                          <input class="form-control" type="text" name="monthlyRent">
                      </div>
                    </div>
                  </div>
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="expenseUpdate" method="post">
                 
                 <%
                 try{
                                Connection con1=new connectionClass().getConnection();
                        		Statement stm=con1.createStatement();
                        		String sql="select * from expense_table where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="text" value="<%=id1%>" name="expenseID">
                   ...
                   <div class="col-sm-4">
                      <div class="form-group">
                        <label>MonthlyExpense</label>
                          <input class="form-control" type="text" name="monthlyExpense" value="<%=rs.getString("monthlyExpense") %>">
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>MonthlyRent</label>
                          <input class="form-control" type="text" name="monthlyRent" value="<%=rs.getString("monthlyRent") %>">
                      </div>
                    </div>
                  </div>
                 </div>
                                    ...
                                    %>
                                        <tr >
                                           ...
                                           <%--  <td id="srNo_<%rs.getString("id");%>"><%=rs.getString("srNo") %></td> --%>
                                            <td id="monthlyExpense_<%rs.getString("id");%>"><%=rs.getString("monthlyExpense") %></td>
                                            <td id="monthlyRent_<%rs.getString("id");%>"><%=rs.getString("monthlyRent") %></td>
                                             <td>
								
								   <a href="expense?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteexpense(<%=rs.getString("id")%>)"  class="text-white btn btn-success"> Delete</a>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title" style="text-align: center">Delete Report</h4>
		        </div>
		        <form action="taxmasterDelete" method="POST">
		        <div class="modal-body">
		          
		          	<input type="hidden" id="taxmasterID_d" name="taxmasterID">
