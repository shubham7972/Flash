...
<head>
  ...
  <link rel="https://cdn.datatables.net/buttons/1.6.5/css/buttons.dataTables.min.css">
   ...
   <script type="text/javascript">   
        function deleteexpensereport(val)
        {
        	//alert(11);
        	var a=val;
        	//alert(a);
        	
        	$("#expenserepID_d").val(a);
        	$("#myModalDelete").modal();
        }
</script>
...
<!-- Sidebar Menu -->
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="expenseRepInsert">
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="expenseRepUpdate" method="post">
                 
                 <%
                 try{
                                Connection con1=new connectionClass().getConnection();
                        		Statement stm=con1.createStatement();
                        		String sql="select * from expensereport_table where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="text" value="<%=id1%>" name="expenserepID">
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                                   ...
                                   Statement smt=con.createStatement();
                                    	String sql = "select * from expensereport_table";
								   ...
								   <a href="expensereport?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteexpensereport(<%=rs.getString("id")%>)"  class="text-white btn btn-success"> Delete</a>
		  ...
		  <div class="modal fade" id="myModalDelete" role="dialog">
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <form action="expenseRepDelete" method="POST">
		        <div class="modal-body">
		          
		          	<input type="hidden" id="expenserepID_d" name="expenserepID">
