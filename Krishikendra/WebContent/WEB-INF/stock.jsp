...
<div class="wrapper">
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="stockInsert">
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="stockUpdate" method="post">
                 
                 <%
                 try{
                                Connection con1=new connectionClass().getConnection();
                        		Statement stm=con1.createStatement();
                        		String sql="select * from stock_report where id= '"+id1+ "'";
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                                   ...
                                   Statement smt=con.createStatement();
                                    	String sql = "select * from stock_report";
								   ...
								   <a href="stock?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteStock(<%=rs.getString("id")%>)" class="btn btn-success text-white">Delete</a>
		    ...
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		          	...
		          	<input type="text" id="stockID_d" name="stockID">
