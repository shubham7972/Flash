...
<div class="wrapper">
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="taxmasterInsert">
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="taxmasterUpdate" method="post">
                 ...
                 try {
                        		...
                        		String sql="select * from taxmaster_table where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="text" value="<%=id1%>" name="taxmasterID">
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Tax Name</label>
                          <select class="form-control" name="taxName" >
                              <option ><%=rs.getString("taxName") %></option>
                              <option>A</option>
                              <option>B</option>
                              <option>C</option>
                              <option>D</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Percentage</label>
                          <input class="form-control" type="text" name="percentage" value="<%=rs.getString("percentage") %>">
                      </div>
                    </div>
                  </div>
                 </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                                   ...
                                   Statement smt=con.createStatement();
                                    	String sql = "select * from taxmaster_table";
								   ...
								   <a href="taxmaster?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteTaxmaster(<%=rs.getString("id")%>)"  class="text-white btn btn-success"> Delete</a>
