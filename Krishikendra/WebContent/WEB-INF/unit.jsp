...
<div class="wrapper">
 ...
 <!-- Start Struts Validation -->
   ...
   <form role="form" action="unitInsert">
   ...
   <!-- for update  -->
                 ...
                 <form role="form" action="unitUpdate" method="post">
                 
                 <%
                 try{
                                Connection con1=new connectionClass().getConnection();
                        		Statement stm=con1.createStatement();
                        		String sql="select * from unit_report where id= '"+id1+ "'";
             ...
             <%-- <%System.out.println(id1); %> --%>
                    <input type="text" value="<%=id1%>" name="unitID">
                    </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tbody>
                                   ...
                                   Statement smt=con.createStatement();
                                    	String sql = "select * from unit_report";
								   ...
								   <a href="unit?id=<%=rs.getString("id")%>" class="btn btn-success">Update</a>  
                            			
					
							</td>
                                            <td>
                                             
                            					<a  onclick="deleteunit(<%=rs.getString("id")%>)"  class="text-white btn btn-success"> Delete</a>
		  ...
		  <div class="modal fade" id="myModalDelete" role="dialog">
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <form action="unitDelete" method="POST">
		        <div class="modal-body">
		          
		          	<input type="hidden" id="unitID_d" name="unitID">
