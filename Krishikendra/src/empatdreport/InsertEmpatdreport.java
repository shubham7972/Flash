...
public class InsertEmpatdreport extends ActionSupport {
	...
	public String execute() {
		...
		String query = "INSERT INTO empatdreport_table (employeeName, date, attendance, inTime, outTime, overtime) VALUES(?, ?, ?, ?, ?, ?)";
		try  {
