...
public class empUpdate extends ActionSupport {
	...
	public String execute() {
		...
		System.out.println("in update............"+empID);
		...
		String query = "UPDATE emp_table SET firstName=?, MiddleName=?, lastName=?, mobileNo=?, designation=?, salary=?, localAddress=?, PermanentAddress=?  WHERE id=?";
