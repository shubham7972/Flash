...
public class InsertEmpreport extends ActionSupport {
	...
	public String execute() {
		...
		String query = "INSERT INTO empreport_table (firstName, MiddleName, lastName, mobileNo, designation, salary, localAddress, PermanentAddress) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
		try  {
