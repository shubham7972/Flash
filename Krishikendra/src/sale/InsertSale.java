...
public class InsertSale extends ActionSupport {
	...
	public String execute() {
		...
		String query = "INSERT INTO sale_table (billDate, billNumber, productName, packaging, quantity, rate, unit, discount) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
		try  {
